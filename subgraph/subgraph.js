...
// 				//console.log("getInputNode(): " + slot);
// 				const link = this.getInputLink(slot);
// 				//console.log("subgraph:");
// 				//console.log(this.subgraph);
// 				const sourceNode = this.subgraph.getNodeById(link.origin_id);
...
// 					//console.log(input);
// 					const link = this.graph._subgraph_node.graph.links[input.link];
// 					return link;
...
// 			getInputNode = function(slot) {
// 				console.log("SubgraphInNode.getInputNode(): " + slot)
// 				const link = this.getInputLink(slot);
// 				const sourceNode = this.graph._subgraph_node.graph.getNodeById(link.source_id);
